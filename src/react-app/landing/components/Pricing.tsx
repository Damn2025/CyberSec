      ...
      <section id="pricing" className="py-12 md:py-20 lg:py-32 bg-black relative">
         ...
         <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="max-w-2xl mx-auto">
               <div className="group p-4 md:p-6 lg:p-8 rounded-2xl border border-red-600/60  relative overflow-hidden hover:border-red-500 hover:shadow-[0_0_80px_rgba(220,38,38,0.45)] transition-all duration-500">
